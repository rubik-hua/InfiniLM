...
MiniCPM5MoeFusedStubDecoderLayer::MiniCPM5MoeFusedStubDecoderLayer(
    ...
    self_attn_ = this->register_module<infinilm::models::minicpm5_moe::MiniCPM5MoeAttention>(
    ...
    if (layer_idx < first_k_dense_replace) {
        dense_mlp_ = this->register_module<infinilm::models::minicpm5_moe::MiniCPM5DenseMLP>(
...
std::tuple<infinicore::Tensor, infinicore::Tensor> MiniCPM5MoeFusedStubDecoderLayer::forward(
...
infinicore::Tensor MiniCPM5MoeFusedStubDecoderLayer::forward(const infinicore::Tensor &positions,
                                                             infinicore::Tensor &hidden_states) {
