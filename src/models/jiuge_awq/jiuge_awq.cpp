...
JiugeAWQModel::JiugeAWQModel(const JiugeAWQMeta *meta, const ModelWeights *weights)
    : ModelBase(*meta, ((JiugeAWQWeights *)(weights))->device(),
                ((JiugeAWQWeights *)(weights))->devIds()),
      weights_(weights)
{
    launch();
}

void JiugeAWQModel::createDeviceResource(AWQDeviceResource *rsrc,
                                          int idev, int ndev,
...
void JiugeAWQModel::releaseDeviceResource(AWQDeviceResource &res) {
...
void JiugeAWQModel::inferDeviceBatch(AWQDeviceResource &rsrc,
                                      int idev, int ndev,
...
createJiugeAWQModel(const JiugeAWQMeta *meta,
    ...
    return new JiugeAWQModel(meta, weights);
}
